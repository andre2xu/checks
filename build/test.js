...
})({"fmusD":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "6ea3e273381043b6";
"use strict";
...
var _nonPrimitivesJs = require("./core/non_primitives.js");
var _primitivesJs = require("./core/primitives.js");
var _dataStructuresJs = require("./core/data_structures.js");
var _numbersJs = require("./core/numbers.js");
var checks = Object.assign({}, _nonPrimitivesJs, _primitivesJs, _dataStructuresJs, _numbersJs);

},{"./core/non_primitives.js":"kwlJS","./core/primitives.js":"lqaNA","./core/data_structures.js":"1qVQH","./core/numbers.js":"1JNZf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kwlJS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
parcelHelpers.export(exports, "checkIfClass", ()=>checkIfClass);
parcelHelpers.export(exports, "isInstanceOf", ()=>isInstanceOf);
parcelHelpers.export(exports, "checkIfInstanceOf", ()=>checkIfInstanceOf);
...
function checkIfFunction(arg) {
    if (isFunction(arg) === false) throw TypeError("Not a function");
}
function isClass(arg) {
    const DESCRIPTORS = Object.getOwnPropertyDescriptors(arg);
    if (DESCRIPTORS.prototype !== undefined && DESCRIPTORS.prototype.writable === false) return true;
    return false;
}
function checkIfClass(arg) {
    if (isClass(arg) === false) throw TypeError("Not a class");
}
function isInstanceOf(arg, parent_class) {
    if (isClass(parent_class)) return arg instanceof parent_class;
    return false;
}
function checkIfInstanceOf(arg, parent_class) {
...
},{}],"lqaNA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
parcelHelpers.export(exports, "arrayHasXNumberOfElements", ()=>arrayHasXNumberOfElements);
parcelHelpers.export(exports, "checkIfArrayHasXNumberOfElements", ()=>checkIfArrayHasXNumberOfElements);
parcelHelpers.export(exports, "isKeyValueObject", ()=>isKeyValueObject);
parcelHelpers.export(exports, "checkIfKeyValueObject", ()=>checkIfKeyValueObject);
parcelHelpers.export(exports, "keyExistsInKeyValueObject", ()=>keyExistsInKeyValueObject);
parcelHelpers.export(exports, "checkIfKeyExistsInKeyValueObject", ()=>checkIfKeyExistsInKeyValueObject);
var _nonPrimitivesJs = require("./non_primitives.js");
function isArray(arg) {
    return arg.constructor === Array;
}
function checkIfArray(arg) {
    if (isArray(arg) === false) throw TypeError("Not an array");
}
function arrayHasXNumberOfElements(array, x) {
    checkIfArray(array);
    if (x < 0) throw TypeError("X must be equal to or greater than 0.");
    return array.length === x;
}
function checkIfArrayHasXNumberOfElements(array, x) {
    if (arrayHasXNumberOfElements(array, x) === false) throw Error("The given array does not have " + x + " element(s)");
}
function isKeyValueObject(arg) {
    return arg.constructor === Object && (0, _nonPrimitivesJs.isClass)(arg) === false;
}
function checkIfKeyValueObject(arg) {
    if (isKeyValueObject(arg) === false) throw TypeError("Not a key value object");
}
function keyExistsInKeyValueObject(key, obj) {
    (0, _nonPrimitivesJs.checkIfString)(key);
    checkIfKeyValueObject(obj);
    return obj[key] !== undefined;
}
function checkIfKeyExistsInKeyValueObject(key, obj) {
